      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {category.items.map((item) => (
                    ...
                    >
                      ...
                      <span className="text-base font-bold text-primary shrink-0 pt-0.5">
          ...
          <p className="mt-12 text-center text-sm text-muted-foreground max-w-xl mx-auto">
            Allergènes disponibles sur demande auprès de notre équipe. Carte mise à
            jour selon les saisons et la disponibilité des produits.
          </p>
        </div>
      </section>
    </Main>
